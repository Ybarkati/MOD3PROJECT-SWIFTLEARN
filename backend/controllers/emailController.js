...
module.exports.create = async (req, res) => {
    const { email, message ,person} = req.body;
    ...
    const mailOptions = {
        ...
        * {
        ...
        <table id="u_content_heading_1" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
          ...
          <h1 class="v-font-size" style="margin: 0px; color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word; font-family: 'Montserrat',sans-serif; font-size: 31px; font-weight: 400;"><strong>SWIFTLEARN</strong></h1>
        ...
        <table id="u_content_text_1" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
          ...
          <div class="v-font-size" style="font-size: 14px; color: #000000; line-height: 180%; text-align: left; word-wrap: break-word;">
            <p style="font-size: 14px; line-height: 180%;"><span style="font-size: 18px; line-height: 32.4px; color: #000000;"><strong><span style="line-height: 32.4px; font-family: Montserrat, sans-serif; font-size: 18px;">Hello <span style="font-size: 16px; line-height: 28.8px; font-family: Montserrat, sans-serif;">${person.toUpperCase()}</span>,</span></strong></span></p>
        <p style="font-size: 14px; line-height: 180%;"><span style="font-family: Montserrat, sans-serif; line-height: 25.2px;"><strong>We're excited to invite you to join <span style="font-size: 16px; line-height: 28.8px; background-color: #ffffff; color: #236fa1;">SWIFTLEARN</span> , where the world of learning awaits. Simply click on the link below, use the access code <span style="color: #e67e23; line-height: 25.2px;"><span style="font-size: 18px; line-height: 32.4px;">${message}</span> </span>, and begin your educational journey with us. Get ready to explore a wealth of interactive courses and connect with a community of passionate learners. We're here to support your growth every step of the way. Let's embark on this learning adventure together!</strong></span></p>
        <p style="font-size: 14px; line-height: 180%;"> </p>
        <p style="font-size: 14px; line-height: 180%;"><span style="font-family: Arvo; line-height: 25.2px;">Best regards,</span></p>
          </div>
        ...
        <table id="u_content_text_2" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
          ...
          <div class="v-font-size" style="font-size: 14px; color: #000000; line-height: 180%; text-align: left; word-wrap: break-word;">
            <p style="line-height: 180%; font-size: 14px;"><span style="font-size: 16px; line-height: 28.8px; font-family: Montserrat, sans-serif;"></span><br /><span style="font-size: 18px; line-height: 32.4px;"><span style="line-height: 32.4px; font-family: Pacifico, cursive; font-size: 18px;">swiftlearn</span></span></p>
          </div>
        ...
        <div align="center">
          <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://swiftlearn-web-about.onrender.com" style="height:62px; v-text-anchor:middle; width:278px;" arcsize="35.5%"  stroke="f" fillcolor="#ed8b03"><w:anchorlock/><center style="color:#FFFFFF;"><![endif]-->
            <a href="https://swiftlearn-web-about.onrender.com" target="_blank" class="v-button v-size-width v-font-size" style="box-sizing: border-box;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #ed8b03; border-radius: 22px;-webkit-border-radius: 22px; -moz-border-radius: 22px; width:48%; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 14px;">
        ...
        <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
          ...
          <div class="v-font-size" style="font-size: 14px; color: #6f7a7a; line-height: 140%; text-align: center; word-wrap: break-word;">
            <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 12px; line-height: 16.8px; font-family: Montserrat, sans-serif;">© 2023 SWIFTLEARN. All Rights Reserved.</span></p>
          </div>
