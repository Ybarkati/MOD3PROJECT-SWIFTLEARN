...
export function Student() {
    ...
    if (isLoading){
      ...
      if (isLoading!=true && Students.length==0){
        return(
         ...
         <Card>
           ...
           <CardBody className="flex flex-col items-center justify-items-center overflow-x-scroll px-0 pt-0 pb-2">
             <img src="https://i.postimg.cc/rmWNmjVh/college-class-amico.png" className="max-w-[400px]" />
             <Link to={'newStudent'} className="text-xl font-medium leading-tight">ADD STUDENT NOW </Link>
           </CardBody>
         </Card>
       </div>
        )
