...
if (isLoading!=true && homework.length==0 && role=="student"){
  return(
  ...
  return(
   ...
   <Card>
     ...
     <CardBody className="flex flex-col items-center justify-items-center overflow-x-scroll px-0 pt-0 pb-2">
       <img src="https://i.postimg.cc/L84N7QgM/Task-amico.png" className="max-w-[400px]" />
       <Link to={'newhomecreate'} className="text-xl font-medium leading-tight">ADD HOMEWORK NOW </Link>
     </CardBody>
   </Card>
 </div>
  )
